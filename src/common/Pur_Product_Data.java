 ...
 * @author RH RIFAT
 */
public class Pur_Product_Data extends javax.swing.JFrame {
...
void showdata(){
    ...
    dt.setRowCount(0);
        ...
        Logger.getLogger(Pur_Product_Data.class.getName()).log(Level.SEVERE, null, ex);
    }
}
    /**
    ...
    private void initComponents() {
        ...
        setTitle("Purchase Product Data");
        setResizable(false);
        ...
        jLabel2.setText("Purchase Product Data");
    ...
    try {
        ...
        if(a1.getText().isEmpty()){
            ...
            config2();
            String ss="SELECT * FROM `super_shop`.`product2` WHERE `Product Id`=?";
        ...
        String s="INSERT INTO `super_shop`.`product2` VALUES(?,?,?,?)";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String s="UPDATE `super_shop`.`product2` SET `Product Name` =?,`Product Price` =?,`Product Details`=? WHERE `Product Id` =?";
        ps=con.prepareStatement(s);
        ps.setString(1, name);
        ps.setString(2, add);
        ps.setString(3, det);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String s="DELETE FROM `super_shop`.`product2` WHERE `Product Id` =?";
        ps=con.prepareStatement(s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pur_Product_Data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pur_Product_Data().setVisible(true);
            }
        });
    }
